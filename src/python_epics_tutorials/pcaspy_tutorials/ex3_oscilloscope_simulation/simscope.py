"""Simulated oscilloscope example from pcaspy.

Example from pcaspy GitHub for simulating oscilloscope:

  - link: https://github.com/paulscherrerinstitute/pcaspy/blob/master/example/simscope.py

Modified for formatting using ruff tool.
"""
...
pvdb = {
    ...
    "MaxPoints": {"type": "int", "value": MAX_POINTS},
    ...
    "Waveform": {"count": MAX_POINTS, "prec": 5},
    "TimeBase": {
        "count": MAX_POINTS,
        "prec": 5,
...
class MyDriver(Driver):
    """pcaspy driver for simulation of oscilloscope."""
    ...
    def write(self, reason, value):
        """Overwrite write method of Driver parent class."""
        status = True
        # take proper actions
